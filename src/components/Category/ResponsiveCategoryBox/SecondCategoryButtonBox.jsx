...
export default function SecondCategoryButton({ lang, data }) {
  ...
  return (
    <Accordion>
      <AccordionSummary
        ...
        id="panel1a-header"
      >
        <Typography sx={{ fontSize: "22px" }}>Second Sub Category</Typography>
      </AccordionSummary>
      ...
      >
        {data.map((v, i) => (
          <Button
            ...
            sx={{
              background:
                v.second_sub_category_id === categoryId ? "#E2FF7F" : "#01466A",
              "&:hover": {
              ...
              fontSize: "12px",
              color:
                v.second_sub_category_id === categoryId ? "black" : "white",
            }}
            onClick={() => {
